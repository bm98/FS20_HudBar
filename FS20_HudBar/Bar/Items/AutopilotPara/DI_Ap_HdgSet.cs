...
namespace FS20_HudBar.Bar.Items
{
  class DI_Ap_HdgSet : DispItem
  {
    ...
    public DI_Ap_HdgSet( ValueItemCat vCat, Label lblProto, Label valueProto, Label value2Proto, Label signProto )
    {
      ...
      _value1 = new V_Deg( value2Proto, m_alignWidth ) { ItemForeColor = cTxSet, ItemBackColor = cValBG };
      this.AddItem( _value1 ); vCat.AddLbl( item, _value1 );

      item = VItem.AP_HDGset_man;
      _value2 = new V_Deg( value2Proto, m_alignWidth ) { ItemForeColor = cTxInfo, Visible = false };
