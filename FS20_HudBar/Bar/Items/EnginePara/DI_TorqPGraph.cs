...
{
  class DI_TorqPGraph : DispItem
  {
    /// <summary>
    /// The Label ID 
    /// </summary>
    public static readonly LItem LItem = LItem.TORQP_ANI;
    /// <summary>
    /// The GUI Name
    /// </summary>
    ...
    /// </summary>
    public static readonly string Desc = "Torque % Graph";
    ...
    public DI_TorqPGraph( ValueItemCat vCat, Label lblProto )
    {
      LabelID = LItem;
      _label = new L_Text( lblProto ) { Text = Short }; this.AddItem( _label );
      var item = VItem.E1_TORQP_ANI;
