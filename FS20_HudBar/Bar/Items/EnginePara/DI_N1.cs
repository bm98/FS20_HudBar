...
namespace FS20_HudBar.Bar.Items
{
  class DI_N1 : DispItem
  {
    ...
    {
      if (this.Visible) {
        _value1.Value = SV.Get<float>( SItem.fG_Eng_T1_N1_prct );
        _value2.Value = SV.Get<float>( SItem.fG_Eng_T2_N1_prct );
        _value3.Value = SV.Get<float>( SItem.fG_Eng_T3_N1_prct );
        _value4.Value = SV.Get<float>( SItem.fG_Eng_T4_N1_prct );
      }
    }
