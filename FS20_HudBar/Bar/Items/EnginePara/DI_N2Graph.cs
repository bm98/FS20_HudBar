...
{
  class DI_N2Graph : DispItem
  {
    /// <summary>
    /// The Label ID 
    /// </summary>
    public static readonly LItem LItem = LItem.N2_ANI;
    /// <summary>
    /// The GUI Name
    /// </summary>
    ...
    /// </summary>
    public static readonly string Desc = "Turbine N2 Graph %";
    ...
    public void OnDataArrival( string dataRefName )
    {
      if ( this.Visible ) {
        ...
        if ( _scale1.Visible ) {
          _scale1.Value = SC.SimConnectClient.Instance.HudBarModule.Engine1_N2_prct; // 0..100
          _scale1.ItemBackColor = ( SC.SimConnectClient.Instance.HudBarModule.Engine1_N2_prct > 102 ) ? cWarnBG : cBG;
        }

        if ( _scale2.Visible && !( _scale3.Visible || _scale4.Visible ) ) {
          _scale2.Value = SC.SimConnectClient.Instance.HudBarModule.Engine1_N2_prct; // 0..100
          _scale2.ValueLScale = SC.SimConnectClient.Instance.HudBarModule.Engine2_N2_prct; // 0..100
          _scale2.ItemBackColor = ( ( SC.SimConnectClient.Instance.HudBarModule.Engine1_N2_prct > 102 ) ||
                                    ( SC.SimConnectClient.Instance.HudBarModule.Engine2_N2_prct > 102 ) ) ? cWarnBG : cBG;
        }

        if ( _scale3.Visible ) {
          // reorder for 3 Engines
          _scale2.Value = SC.SimConnectClient.Instance.HudBarModule.Engine1_N2_prct; // 0..100
          _scale2.ValueLScale = SC.SimConnectClient.Instance.HudBarModule.Engine3_N2_prct; // 0..100
          _scale2.ItemBackColor = ( ( SC.SimConnectClient.Instance.HudBarModule.Engine1_N2_prct > 102 ) ||
                                    ( SC.SimConnectClient.Instance.HudBarModule.Engine3_N2_prct > 102 ) ) ? cWarnBG : cBG;

          _scale3.Value = SC.SimConnectClient.Instance.HudBarModule.Engine2_N2_prct; // 0..100
          _scale3.ItemBackColor = ( SC.SimConnectClient.Instance.HudBarModule.Engine2_N2_prct > 102 ) ? cWarnBG : cBG;
        }
        ...
        if ( _scale4.Visible ) {
          ...
          _scale4.Value = SC.SimConnectClient.Instance.HudBarModule.Engine2_N2_prct; // 0..100
          _scale4.ValueLScale = SC.SimConnectClient.Instance.HudBarModule.Engine4_N2_prct; // 0..100
          _scale4.ItemBackColor = ( ( SC.SimConnectClient.Instance.HudBarModule.Engine2_N2_prct > 102 ) ||
                                    ( SC.SimConnectClient.Instance.HudBarModule.Engine4_N2_prct > 102 ) ) ? cWarnBG : cBG;
        }
      }
    }
