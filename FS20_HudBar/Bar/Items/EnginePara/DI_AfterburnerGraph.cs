    ...
    private void OnDataArrival( string dataRefName )
    {
      if ( this.Visible ) {
        ...
        if ( _scale1.Visible ) {
          ...
          _scale1.ItemBackColor = ( SC.SimConnectClient.Instance.HudBarModule.Afterburner1_prct * 100 > 102 ) ? cWarnBG : cBG;
        }
        if ( _scale2.Visible && !( _scale3.Visible || _scale4.Visible ) ) {
          ...
          _scale2.ValueLScale = SC.SimConnectClient.Instance.HudBarModule.Afterburner2_prct * 100; // 0..100
          _scale2.ItemBackColor = ( ( SC.SimConnectClient.Instance.HudBarModule.Afterburner1_prct * 100 > 102 ) ||
                                    ( SC.SimConnectClient.Instance.HudBarModule.Afterburner2_prct * 100 > 102 ) ) ? cWarnBG : cBG;
        }

        if ( _scale3.Visible ) {
          // reorder for 3 Engines
          _scale2.Value = SC.SimConnectClient.Instance.HudBarModule.Afterburner1_prct * 100; // 0..100
          _scale2.ValueLScale = SC.SimConnectClient.Instance.HudBarModule.Afterburner3_prct * 100; // 0..100
          _scale2.ItemBackColor = ( ( SC.SimConnectClient.Instance.HudBarModule.Afterburner1_prct * 100 > 102 ) ||
                                    ( SC.SimConnectClient.Instance.HudBarModule.Afterburner3_prct * 100 > 102 ) ) ? cWarnBG : cBG;

          _scale3.Value = SC.SimConnectClient.Instance.HudBarModule.Afterburner2_prct * 100; // 0..100
          _scale3.ItemBackColor = ( SC.SimConnectClient.Instance.HudBarModule.Afterburner2_prct * 100 > 102 ) ? cWarnBG : cBG;
        }
        if ( _scale4.Visible ) {
          ...
          _scale4.Value = SC.SimConnectClient.Instance.HudBarModule.Afterburner2_prct * 100; // 0..100
          _scale4.ValueLScale = SC.SimConnectClient.Instance.HudBarModule.Afterburner4_prct * 100; // 0..100
          _scale4.ItemBackColor = ( ( SC.SimConnectClient.Instance.HudBarModule.Afterburner2_prct * 100 > 102 ) ||
                                    ( SC.SimConnectClient.Instance.HudBarModule.Afterburner4_prct * 100 > 102 ) ) ? cWarnBG : cBG;
        }
      }
    }
