...
{
  class DI_UserAlert3 : DI_UserAlert
  {

    /// <summary>
    /// The Label ID 
    /// </summary>
    public static new readonly LItem LItem = LItem.USR_ALERT_3;
    /// <summary>
    /// The GUI Name
    /// </summary>
    public static new readonly string Short = "ALRT 3";
    /// <summary>
    /// The Configuration Description
    /// </summary>
    public static new readonly string Desc = "Alert 3";

    public DI_UserAlert3( ValueItemCat vCat, Label lblProto, Label valueProto, Label value2Proto, Label signProto )
    {
      TText = "Click to switch the Alert type";

      LabelID = LItem;
      var item = VItem.USR_ALERT_3;
