...
namespace FS20_HudBar.Bar.Items
{
  class DI_Baro_InHg : DispItem
  {
    ...
    public DI_Baro_InHg( ValueItemCat vCat, Label lblProto, Label valueProto, Label value2Proto, Label signProto )
    {
    ...
    {
      if (this.Visible) {
        _value1.Value = SV.Get<float>( SItem.fG_Acft_Altimeter1_setting_inHg );
      }
    }
