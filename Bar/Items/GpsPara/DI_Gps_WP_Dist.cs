...
namespace FS20_HudBar.Bar.Items
{
  class DI_Gps_WP_Dist : DispItem
  {
    ...
    /// The GUI Name
    /// </summary>
    public static string Short = "DIST";
    /// <summary>
    /// The Configuration Description
    /// </summary>
    public static string Desc = "WYP Distance nm";

    private readonly V_Base _label;
    private readonly V_Base _value1;

    public DI_Gps_WP_Dist( ValueItemCat vCat, Label lblProto, Label valueProto, Label value2Proto, Label signProto, bool showUnits )
    {
      LabelID = LItem;
      var item = VItem.GPS_WP_DIST;
      _label = new L_Text( lblProto ) { Text = Short }; this.AddItem( _label );
      _value1 = new V_Dist( valueProto, showUnits ) { ItemForeColor = cGps };
