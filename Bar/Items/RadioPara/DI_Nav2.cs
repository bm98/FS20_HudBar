...
namespace FS20_HudBar.Bar.Items
{
  class DI_Nav2 : DispItem
  {
    ...
    {
      if ( this.Visible ) {
        _value1.Text = $"{SC.SimConnectClient.Instance.NavModule.Nav2_stdby_hz / 1_000_000f:000.00}";
        _value2.Text = $"{SC.SimConnectClient.Instance.NavModule.Nav2_active_hz / 1_000_000f:000.00}";
      }
    }
