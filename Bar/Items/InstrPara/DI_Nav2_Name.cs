...
namespace FS20_HudBar.Bar.Items
{
  class DI_Nav2_Name : DispItem
  {
    ...
    /// </summary>
    public static string Desc = "NAV-2 Name {Apt}";

    private readonly V_Base _label;
    private readonly V_Base _value1;

    public DI_Nav2_Name( ValueItemCat vCat, Label lblProto, Label valueProto, Label value2Proto, Label signProto, bool showUnits )
    {
      LabelID = LItem;
