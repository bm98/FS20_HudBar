...
namespace FS20_HudBar.Bar.Items
{
  class DI_Alt_Inst : DispItem
  {
    ...
    /// </summary>
    public static string Desc = "Aircraft ALT ft";

    private readonly V_Base _label;
    private readonly V_Base _value1;

    public DI_Alt_Inst( ValueItemCat vCat, Label lblProto, Label valueProto, Label value2Proto, Label signProto, bool showUnits )
    {
      LabelID = LItem;
    ...
    {
      if ( this.Visible ) {
        _value1.Value = SC.SimConnectClient.Instance.AircraftModule.Altimeter_ft;
      }
    }
