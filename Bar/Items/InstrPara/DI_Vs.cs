...
namespace FS20_HudBar.Bar.Items
{
  class DI_Vs : DispItem
  {
    ...
    /// </summary>
    public static string Desc = "Aircraft VS fpm (arrows)";

    private readonly V_Base _label;
    private readonly V_Base _value1;

    public DI_Vs( ValueItemCat vCat, Label lblProto, Label valueProto, Label value2Proto, Label signProto, bool showUnits )
    {
      LabelID = LItem;
      var item = VItem.VS;
