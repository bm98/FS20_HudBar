...
namespace FS20_HudBar.Bar.Items
{
  class DI_Oat_F : DispItem
  {
    ...
    /// The GUI Name
    /// </summary>
    public static string Short = "OAT";
    /// <summary>
    /// The Configuration Description
    /// </summary>
    public static string Desc = "Outside Air Temp °F";

    private readonly V_Base _label;
    private readonly V_Base _value1;

    public DI_Oat_F( ValueItemCat vCat, Label lblProto, Label valueProto, Label value2Proto, Label signProto, bool showUnits )
    {
      LabelID = LItem;
      // OAT
