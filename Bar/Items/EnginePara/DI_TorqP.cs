...
namespace FS20_HudBar.Bar.Items
{
  class DI_TorqP : DispItem
  {
    ...
    /// </summary>
    public static string Desc = "Torque %";
    ...
    {
      if ( this.Visible ) {
        _value1.Value = SC.SimConnectClient.Instance.EngineModule.Turbine1_Torque_prct / 100;// needs to be 0..1
        _value2.Value = SC.SimConnectClient.Instance.EngineModule.Turbine2_Torque_prct / 100;// needs to be 0..1
