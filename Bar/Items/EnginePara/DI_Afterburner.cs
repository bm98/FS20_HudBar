...
namespace FS20_HudBar.Bar.Items
{
  class DI_Afterburner : DispItem
  {
    ...
    {
      if ( this.Visible ) {
        _value1.Value = SC.SimConnectClient.Instance.HudBarModule.Afterburner1_prct;// needs to be 0..1
        _value2.Value = SC.SimConnectClient.Instance.HudBarModule.Afterburner2_prct;// needs to be 0..1
        _value3.Value = SC.SimConnectClient.Instance.HudBarModule.Afterburner3_prct;// needs to be 0..1
        _value4.Value = SC.SimConnectClient.Instance.HudBarModule.Afterburner4_prct;// needs to be 0..1
      }
    }
