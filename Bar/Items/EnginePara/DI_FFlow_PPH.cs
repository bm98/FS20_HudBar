...
namespace FS20_HudBar.Bar.Items
{
  class DI_FFlow_PPH : DispItem
  {
    ...
    /// </summary>
    public static string Desc = "Fuel Flow pph";
    ...
    {
      if ( this.Visible ) {
        _value1.Value = SC.SimConnectClient.Instance.EngineModule.Engine1_FuelFlow_lbPh;
        _value2.Value = SC.SimConnectClient.Instance.EngineModule.Engine2_FuelFlow_lbPh;
