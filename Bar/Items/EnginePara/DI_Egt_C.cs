...
namespace FS20_HudBar.Bar.Items
{
  class DI_Egt_C : DispItem
  {
    ...
    /// </summary>
    public static string Desc = "Engine EGT °C";
    ...
    {
      if ( this.Visible ) {
        _value1.Value = SC.SimConnectClient.Instance.EngineModule.Engine1_egt_degC;
        _value2.Value = SC.SimConnectClient.Instance.EngineModule.Engine2_egt_degC;
