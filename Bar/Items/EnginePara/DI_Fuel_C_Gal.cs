...
namespace FS20_HudBar.Bar.Items
{
  class DI_Fuel_C_Gal : DispItem
  {
    ...
    /// The GUI Name
    /// </summary>
    public static string Short = "F-C";
    /// <summary>
    /// The Configuration Description
    /// </summary>
    public static string Desc = "Fuel Center Gal";

    private readonly V_Base _label;
    private readonly V_Base _value1;

    public DI_Fuel_C_Gal( ValueItemCat vCat, Label lblProto, Label valueProto, Label value2Proto, Label signProto, bool showUnits )
    {
      LabelID = LItem;
