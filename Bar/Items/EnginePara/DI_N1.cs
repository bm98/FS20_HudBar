...
namespace FS20_HudBar.Bar.Items
{
  class DI_N1 : DispItem
  {
    ...
    /// The GUI Name
    /// </summary>
    public static string Short = "N1";
    /// <summary>
    /// The Configuration Description
    /// </summary>
    public static string Desc = "Turbine N1 %";
    ...
    {
      if ( this.Visible ) {
        _value1.Value = SC.SimConnectClient.Instance.EngineModule.Engine1_N1_prct / 100;// needs to be 0..1
        _value2.Value = SC.SimConnectClient.Instance.EngineModule.Engine2_N1_prct / 100;// needs to be 0..1
