...
namespace FS20_HudBar.Bar.Items
{
  class DI_Prop_LEV : DispItem
  {
    ...
    {
      if ( this.Visible ) {
        _value1.Value = SC.SimConnectClient.Instance.HudBarModule.PropellerLever1_prct;
        _value2.Value = SC.SimConnectClient.Instance.HudBarModule.PropellerLever2_prct;
