...
namespace FS20_HudBar.Bar.Items
{
  class DI_Thr_LEV : DispItem
  {
    ...
    /// The GUI Name
    /// </summary>
    public static string Short = "%Thr";
    /// <summary>
    /// The Configuration Description
    /// </summary>
    public static string Desc = "Throttle Handle %";
    ...
    {
      if ( this.Visible ) {
        _value1.Value = SC.SimConnectClient.Instance.ControlsModule.ThrottleLever1_prct;
        _value2.Value = SC.SimConnectClient.Instance.ControlsModule.ThrottleLever2_prct;
