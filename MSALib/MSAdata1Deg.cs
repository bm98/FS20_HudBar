...
namespace MSALib
{
  internal class MSAdata1Deg
  {
    private const int c_degMult = 1;   // resolution is 1/ N degree
    ...
    private const string c_msaFileName = @".\MSAdata1Deg.dat";
    ...
    public MSAdata1Deg( )
    {
      ...
      if (File.Exists( c_msaFileName )) {
        ...
        using (Stream msaStream = System.Reflection.Assembly.GetExecutingAssembly( ).GetManifestResourceStream( @"MSALib.MSAdata1Deg.dat" )) {
